...
import com.KamyEsm.AAA.Service.Oauth2.Oauth2RegisteredClientService;
...
public class SecurityConfig {
    ...
    @Bean
    public RegisteredClientRepository registeredClientRepository(Oauth2RegisteredClientService service) {
        return service;
    }
